...
class RTree
{
typedef bool (*HHFunc)(DATATYPE, void*);
protected: 
...
public:
  ...
  int Search(const ELEMTYPE a_min[NUMDIMS], const ELEMTYPE a_max[NUMDIMS],
        HHFunc a_resultCallback, void* a_context);
...
protected:
  ...
  bool Search(Node* a_node, Rect* a_rect, int& a_foundCount, HHFunc
    a_resultCallback, void* a_context);
